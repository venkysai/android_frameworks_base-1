...
public class BatteryMeterView extends LinearLayout implements
    ...
    private int mClockStyle = CLOCK_DATE_POSITION_DEFAULT;
    public static final int CLOCK_DATE_POSITION_DEFAULT = 0;
    public static final int CLOCK_DATE_POSITION_LEFT = 3;
    ...
    private boolean isRightClock() {
        return mClockStyle == CLOCK_DATE_POSITION_DEFAULT;
    }
    ...
    public void updateSettings(boolean fromObserver) {
        ...
        mClockStyle = Settings.System.getIntForUser(mContext.getContentResolver(),
                Settings.System.STATUS_BAR_CLOCK_DATE_POSITION, CLOCK_DATE_POSITION_DEFAULT, mUser);
